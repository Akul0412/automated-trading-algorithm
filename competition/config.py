...
MOM_STOP_LOSS_PCT = _env_float("COMP_MOM_STOP_LOSS_PCT", 0.012)
MOM_PROFIT_TARGET_PCT = _env_float("COMP_MOM_PROFIT_TARGET_PCT", 0.02)
MOM_TRAILING_ACTIVATE_PCT = _env_float("COMP_MOM_TRAILING_ACTIVATE_PCT", 0.012)
...
MOM_MAX_ENTRIES_PER_TICKER = _env_int("COMP_MOM_MAX_ENTRIES_PER_TICKER", 2)
MOM_CONFIRM_BARS = _env_int("COMP_MOM_CONFIRM_BARS", 2)
